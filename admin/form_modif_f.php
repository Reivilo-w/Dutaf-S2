...
<html>
	...
	<div class="container">
		...
		<div class="row"
>			<form class="col-12" action="valide_modif_f.php" method="post">
				<div class="form-row">
					<input type="password" name="numf"  value="<?=$id?>" hidden>
					<div class="form-group col-md-4">
						<label for="inputRef">Nom</label>
						<input type="text" class="form-control" id="inputRef" placeholder="Nom" name="nom" value="<?=$dataF['f_nom']?>">
					</div>
					<div class="form-group col-md-4">
						<label for="inputDesc">Téléphone</label>
						<input type="text" class="form-control" id="inputDesc" placeholder="Téléphone" name="tel" value="<?=$dataF['f_tel']?>">
					</div>
					<div class="form-group col-md-4">
						<label for="inputPrice">Ville</label>
						<input type="text" class="form-control" id="inputPrice" placeholder="Ville" name="ville" value="<?=$dataF['f_ville']?>">
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-4">
