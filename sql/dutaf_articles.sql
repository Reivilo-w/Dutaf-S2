...
--
-- Structure de la table `dutaf_articles`
--

DROP TABLE IF EXISTS `dutaf_articles`;
CREATE TABLE IF NOT EXISTS `dutaf_articles` (
  `art_id` int(11) NOT NULL AUTO_INCREMENT,
  `art_design` varchar(25) DEFAULT NULL,
  `art_desc` varchar(255) DEFAULT NULL,
  `art_prix` float DEFAULT NULL,
  `art_quantity` int(11) DEFAULT NULL,
  `_f_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`art_id`)
) ENGINE=InnoDB AUTO_INCREMENT=537 DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `dutaf_articles`
--

INSERT INTO `dutaf_articles` (`art_id`, `art_design`, `art_desc`, `art_prix`, `art_quantity`, `_f_id`) VALUES
...
(122, '12911', 'PENDULE PORTE PHOTO ', 7.14, 39, 8),
